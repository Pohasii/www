...
<div class="wrap">
	...
	<? } else echo 'Авторизуйтесь/введите логин(в играх) в личном кабинете/турнир завершен'; // сообщение (нужно перефразировать правильно) если не зарегистрирован/либо логин не введ в личном кабинете (заместо кнопки выводится) ?>
